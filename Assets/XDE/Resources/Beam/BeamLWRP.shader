...
Shader "Lightweight Render Pipeline/Beam/Wrap"
{
...
#include "Packages/com.unity.render-pipelines.universal/Shaders/LitInput.hlsl"
          ...
          GS_INPUT LitPassVertex(Attributes input)
          {
            ...
            output.pos = mul(unity_ObjectToWorld, input.positionOS);
            output.normal = mul(unity_ObjectToWorld, float4(input.normalOS,0.0f)).xyz;
            output.tangent = mul(unity_ObjectToWorld, float4(input.tangentOS,0.0f)).xyz;
