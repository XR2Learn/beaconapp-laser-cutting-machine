...
namespace ManusVR.Core.Tracking
{
    public class TrackingManager : MonoBehaviour
    {
        ...
        protected XdeManusVRManager ManusVRManager;

        protected virtual void Start()
        {
            ManusVRManager = ManusVRManager ?? GetComponent<XdeManusVRManager>();
        ...
        private void AttachTransformFollow(Transform transformToMove, Transform transformToFollow, Vector3 positionOffset, Vector3 rotationOffset, out TransformFollow transformFollow)
        {
            AttachTransformFollow(transformToMove, transformToFollow, out transformFollow);
            transformFollow.positionOffset = positionOffset;
            transformFollow.rotationOffset = rotationOffset;
        }
