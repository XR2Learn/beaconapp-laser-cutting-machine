...
namespace Hover.Core.Items.Managers {
	...
	public class HoverItemSelectionState : MonoBehaviour {
        ...
        public delegate void OnSelection(CursorType type);
        public static OnSelection HapticReturn;
		...
		private bool UpdateState() {
            ...
            CursorType tmpcursor = CursorType.Look;
			...
			selData.Select();
            if (HapticReturn != null)
                HapticReturn(tmpcursor);
			return true;
		}
